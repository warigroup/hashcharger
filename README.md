...
[1.0.0](https://github.com/warigroup/hashcharger/releases/tag/v1.0.0) : First alpha release. You will not able to set/collect fees yet, this will be in the next release. 
